...
$(document).ready(function(){
    var experienceSlider = $("#testimonial-slider");
    ...
    experienceSlider.on('click touchstart', '.testimonial, .owl-nav button', function(){
        experienceSlider.trigger('stop.owl.autoplay');
    });
});
